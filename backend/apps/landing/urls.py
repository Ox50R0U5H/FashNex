...
from .views import HomeAggregateAPI, HomeStylesAPI, HomeVendorsAPI, HomeBestSellersAPI, subscribe_email_api
...
urlpatterns = [
    ...
    path("subscribe/", subscribe_email_api, name="subscribe"),
]
